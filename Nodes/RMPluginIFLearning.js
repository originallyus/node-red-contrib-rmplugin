module.exports = function(RED) {
    function rmpluginIFLearning(config) {
   ...
   // Retrieve the config node
        ...
        if (this.server) {
            ...
            const http = require("http");
               var url = "http://" + this.server.ipaddress + ":" + this.server.port+"/study?deviceMac="+deviceMAC;
    ...
    RED.nodes.registerType("Learn New Code",rmpluginIFLearning);
